...
const String serverUrl = 'http://10.57.130.116:5000';
...
class LiveAnalysisScreenState extends State<LiveAnalysisScreen>
  ...
  void _initAnimations() {
    ...
    _slideAnimation = Tween<Offset>(
      begin: const Offset(0.0, 1.0), // Changed to slide up from bottom on mobile
      end: Offset.zero,
        ...
        return Transform.scale(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Icon(statusIcon, color: statusColor, size: isSmallScreen ? 14 : 16),
      ...
      builder: (context, child) {
        return Stack(
          children: [
            ...
            Positioned(
              top: (_scanAnimation.value * (MediaQuery.of(context).size.height * 0.3)) - 1,
              left: 0,
              right: 0,
              child: Container(
                height: 2,
...
class MobileResultsWidget extends StatelessWidget {
  ...
  Widget _buildMobileConfidenceChip(double confidence) {
    ...
    return Container(
      key: ValueKey('${label}_${confidence.toStringAsFixed(1)}'), // Key for AnimatedSwitcher
